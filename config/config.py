...
BOT_TOKEN = getenv("BOT_TOKEN", "7819249411:AAHBwacCoXZl71xq8yF1bkqgxqzTkoFPCYA")

# Database to save your chats and stats... Get MongoDB:-  https://telegra.ph/How-To-get-Mongodb-URI-04-06
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://Koi:aloksingh@cluster0.86wo9.mongodb.net/?retryWrites=true&w=majority")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002669902570"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Test Miko")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7970350353").split())
